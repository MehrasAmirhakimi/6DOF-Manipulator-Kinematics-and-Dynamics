...
%         end
        ...
        theta51 = atan2((R(3, 1)^2 + R(3, 2)^2)^0.5, R(3, 3));
        theta52 = atan2(-(R(3, 1)^2 + R(3, 2)^2)^0.5, R(3, 3));
        if S(theta51) ~= 0
            theta41 = atan2(-R(2, 3)/S(theta51), -R(1, 3)/S(theta51));
            theta42 = atan2(-R(2, 3)/S(theta52), -R(1, 3)/S(theta52));
            theta61 = atan2(-R(3, 2)/S(theta51), R(3, 1)/S(theta51));
            theta62 = atan2(-R(3, 2)/S(theta52), R(3, 1)/S(theta52));
        elseif theta51 == 0
            theta41 = 0;
            theta42 = theta41;
